 ...
 * Original file: /Users/jried31/Documents/workspace/android/mytracksV2/MyTracksLib/src/com/google/android/apps/mytracks/services/ITrackRecordingService.aidl
 */
...
static final int TRANSACTION_startGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_stopGps = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_startNewTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_pauseCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_resumeCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_endCurrentTrack = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_isRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_isPaused = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getRecordingTrackId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getTotalTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_insertWaypoint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_insertTrackPoint = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getSensorData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getSensorState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
}
/**
   * Starts gps.
   */
